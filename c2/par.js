$(function() {
  ...
  $("#quick a").click(function() {
    //퀵 또는 메인메뉴 버튼 클릭시 스크롤링
    var aPage = parseInt($(this).attr("data-val"));
    $("body, html")
      .not(":animated")
      .animate({ scrollTop: aPage * win_h }, 1200);
  ...
  $("#quick_up").click(function() {
    //퀵 메뉴에서 위로 버튼 눌렀을 때 가장 위로 스크롤링
    $("body, html")
      .not(":animated")
      .animate({ scrollTop: "0px" }, 1200);
  });
  var pageCnt = $(".page").length - 1;
  $("#quick_down").click(function() {
    //퀵 메뉴에서 아래로 버튼 눌렀을 때 가장 끝으로
